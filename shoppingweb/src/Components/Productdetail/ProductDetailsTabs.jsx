...
const ProductDetailsTabs = ({ selectedProduct }) => {
          ...
          <TabContent activeTab={activeTab} className="mt-4 fs-16">
            <TabPane tabId="1">
              <p className="justify-paragraph">
                ...
                doloribus eligendi autem soluta fuga, ex obcaecati eum ab
                libero. Libero, voluptatem dignissimos totam ipsa cumque sequi
                illum mollitia exercitationem culpa, animi minus voluptatibus
                eveniet! Ex nihil, modi sit consequuntur ipsum accusamus.
              </p>
                    ...
                    <React.Fragment key={index}>
                      ...
                      <Col xs={10} lg={10} xl={11}>
                        <div className="d-flex justify-content-between">
                          ...
                          <div className="fs-12">
                            <span className="cursor-pointer">Leave Reply</span>
                          </div>
                        </div>
                        <p className="my-3 justify-paragraph">{items.title}</p>
                        <Row className="align-items-center fs-14">
